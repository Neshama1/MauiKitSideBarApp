...
#define COMPONENT_NAME "%{APPNAMELC}"
#define PROJECT_DESCRIPTION "Convergent app..."
#define PROJECT_YEAR "2022"
#define PRODUCT_NAME "%{APPNAMELC}"
#define PROJECT_PAGE "https://%{APPNAMELC}.kde.org"
#define REPORT_PAGE "https://bugs.kde.org/enter_bug.cgi?product=%{APPNAMELC}"
